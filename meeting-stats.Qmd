...
#### Studio Sign In Times
This shows when people signed in each day. People usually don't come in all at once. More popular days will have more squares
```{r}
time_plot <- member_time |>
  mutate(hour = hour(`Sign In`)) |>
  count(hour, date) |>
